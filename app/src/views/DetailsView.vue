      ...
      <div class="row">
        ...
        <div class="col-lg-6 product-details pl-md-5">
          ...
          <div class="row mt-4">
            ...
            <div class="w-100"></div>
            <div class="col-md-12">
              <p style="color: #000">{{ product.available }} piece available</p>
            </div>
          </div>
          <p>
            <a href="cart.html" class="btn btn-primary py-3 px-5 mr-2"
              >Add to Cart</a
...
export default {
    ...
    methods: {
      handleIdProd() {
        if (location.href.slice(-2, location.href.length).includes('/')) {
          console.log(location.href.slice(-2, location.href.length).slice(1));
        }
      }
    },
    computed: {
    ...
    mounted() {
      createStore.dispatch('getProduct', parseInt(location.href.slice(location.href.length - 2)))
	}
};
</script>
